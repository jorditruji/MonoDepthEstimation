...
if __name__ == '__main__':
    ...
    for epoch in range(n_epoch):
        ...
        for _i, (depths, rgbs, filename) in enumerate(training_generator):
            ...
            predicts, grads,  mani_depth = net(inputs,outputs, mani_RGB)
            ...
            # Manifold loss
                ...
                loss =  embed_lose #depth_loss + 10*gradie_loss# +(0.5**epoch)*embed_lose# + normal_loss
        ...
        if loss_val< best_loss and epoch>2:
            ...
            torch.save({'model': best_model_wts, 'optim':optimizer_ft.state_dict() }, 'pesos_custom_1')
            torch.save({'model': encoer_wts, 'optim':optimizer_ft.state_dict() }, 'pesos_custom_encoderonly')
